<?php /* Smarty version 2.6.25, created on 2010-09-06 20:55:37
         compiled from admin_up.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'admin_up.tpl', 4, false),array('modifier', 'bbcode2html', 'admin_up.tpl', 135, false),)), $this); ?>
<div id="navigation">
	<div id="main-nav">
		<ul class="tabbed">
	...
	<div id="sub-nav">
		...
		<?php if ($this->_supers['session']['amxadmins_view'] == 'yes'): ?>
			...
			<table width="95%"><tr><td>
				...
				<table border="1" width="100%">
					<tr class="htabletop">
						<td colspan="4"><b><?php echo ((is_array($_tmp='_WEBVERSIONINFO')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</b></td>
					</tr>
					<tr class="htablebottom">
						<td><?php echo ((is_array($_tmp='_WEB')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
						<td width="20%"><?php echo ((is_array($_tmp='_VERSION_CURRENT')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
						<td width="20%"><?php echo ((is_array($_tmp='_VERSION_RELEASE')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
						<td width="20%"><?php echo ((is_array($_tmp='_VERSION_BETA')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
					</tr>
					<tr class="settings_line">
						...
						<td>
							<?php if ($this->_tpl_vars['version_web'] < $this->_tpl_vars['version_db_web']['release'] && $this->_tpl_vars['version_db_web']['recommended_to'] >= $this->_tpl_vars['version_web']): ?>
...
" />
						...
						<td><?php echo $this->_tpl_vars['version_db_web']['release']; ?>
</td>
						<td><?php echo $this->_tpl_vars['version_db_web']['beta']; ?>
</td>
					</tr>
				</table>
				<br />
				...
				<table border="1" width="100%">
					...
					<?php if ($this->_tpl_vars['server_count'] == 0): ?>
						<tr>
							...
							<td><?php echo $this->_tpl_vars['version_db_plugin']['release']; ?>
</td>
							<td><?php echo $this->_tpl_vars['version_db_plugin']['beta']; ?>
</td>
						</tr>
					<?php else: ?>
...
?>
						<tr>
							...
							<td>
								<?php if ($this->_tpl_vars['version_server']['version'] < $this->_tpl_vars['version_db_plugin']['release'] && $this->_tpl_vars['version_db_plugin']['recommended_to'] >= $this->_tpl_vars['version_server']['version']): ?>
...
" />
			...
			<table width="95%" style="margin:0;"><tr><td width="49%" valign="top">
				...
				<table border="1" width="100%" style="margin:0;">
					<tr class="htable">
						<td colspan="4"><?php echo ((is_array($_tmp='_LASTCHANGELOG')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
					</tr>
					<tr class="settings_line">
						<td width="15%" valign="top"><b><?php echo ((is_array($_tmp='_WEB')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</b></td>
						<td><?php echo ((is_array($_tmp=$this->_tpl_vars['version_db_web']['changelog'])) ? $this->_run_mod_handler('bbcode2html', true, $_tmp) : smarty_modifier_bbcode2html($_tmp)); ?>
</td>
					</tr>
					<tr class="settings_line">
						<td width="15%" valign="top"><b><?php echo ((is_array($_tmp='_PLUGIN')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</b></td>
						<td><?php echo ((is_array($_tmp=$this->_tpl_vars['version_db_plugin']['changelog'])) ? $this->_run_mod_handler('bbcode2html', true, $_tmp) : smarty_modifier_bbcode2html($_tmp)); ?>
</td>
					</tr>
				</table>
				<br />
			</table>
			<?php if ($this->_tpl_vars['web'] == true): ?><center><div class="admin_msg"><img src="images/warning.gif" border="0" /> <a href="<?php echo $this->_tpl_vars['version_db_web']['url']; ?>
" target="_blank"><?php echo ((is_array($_tmp='_WEBUPDATE_RECOMMENDED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
			...
			<?php if ($this->_tpl_vars['plugin'] == true): ?><center><div class="admin_msg"><img src="images/warning.gif" border="0" /> <a href="<?php echo $this->_tpl_vars['version_db_plugin']['url']; ?>
...
?>
				<div class="admin_msg" style="font-weight:bold;color:red;"><?php echo ((is_array($_tmp=$this->_tpl_vars['error'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</div>
			<?php endforeach; endif; unset($_from); ?>
			<br />
		<?php else: ?>
