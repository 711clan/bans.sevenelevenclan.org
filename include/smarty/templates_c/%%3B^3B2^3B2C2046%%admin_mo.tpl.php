<?php /* Smarty version 2.6.25, created on 2010-09-06 20:55:34
...
" <?php if ($this->_supers['session']['websettings_edit'] !== 'yes'): ?>disabled<?php endif; ?> />
				...
				<br />
				<div class="admin_msg"><?php if ($this->_tpl_vars['msg']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
<?php endif; ?></div>
			<?php else: ?>
