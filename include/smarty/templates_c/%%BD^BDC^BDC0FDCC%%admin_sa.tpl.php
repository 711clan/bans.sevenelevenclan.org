<?php /* Smarty version 2.6.25, created on 2010-09-06 20:56:19
...
" /></td>
				...
				<br />
				<?php if ($this->_tpl_vars['msg']): ?><div class="admin_msg" align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</div><?php endif; ?>
...
" />
						<input type="checkbox" name="aktiv_new[]" value="<?php echo $this->_tpl_vars['admins']['aid']; ?>
" <?php if ($this->_tpl_vars['admins']['aktiv'] == 1): ?>checked<?php endif; ?> 
							onclick="document.getElementById('cf<?php echo $this->_tpl_vars['admins']['aid']; ?>
