<?php /* Smarty version 2.6.25, created on 2010-09-06 20:55:10
...
');" <?php if ($this->_supers['session']['websettings_edit'] !== 'yes'): ?>disabled<?php endif; ?> /></div>
		...
		<?php if ($this->_tpl_vars['msg'] <> ""): ?>
			<table border="0" width="50%" align="center"><tr><td class="admin_msg" align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td></tr></table>
		<?php endif; ?>
		</td>
	</tr>
