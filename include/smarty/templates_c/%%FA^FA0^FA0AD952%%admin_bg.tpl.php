<?php /* Smarty version 2.6.25, created on 2010-09-06 20:56:24
...
" <?php if ($this->_supers['session']['servers_edit'] !== 'yes'): ?>disabled<?php endif; ?> /></td>
			...
			<br>
			<div class="admin_msg"><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</div>
			<br>
			<?php endif; ?>
			</td></tr></table>
