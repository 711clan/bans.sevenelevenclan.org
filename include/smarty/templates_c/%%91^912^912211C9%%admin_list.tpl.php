<?php /* Smarty version 2.6.25, created on 2010-09-20 17:17:58
         compiled from admin_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'admin_list.tpl', 7, false),array('modifier', 'date_format', 'admin_list.tpl', 35, false),)), $this); ?>
<div class="main">
	<div class="post">
...
"/></a>&nbsp;</td>
                        ...
                        <?php echo $this->_tpl_vars['admins']['steamid']; ?>
						...
						<td>
                        <?php if ($this->_supers['session']['loggedin'] == 'true'): ?>
                        <?php echo $this->_tpl_vars['admins']['access']; ?>
						...
						<td>
                        <?php echo ((is_array($_tmp=$this->_tpl_vars['admins']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d. %b %Y - %T") : smarty_modifier_date_format($_tmp, "%d. %b %Y - %T")); ?>
</td> 
						<td><em>
