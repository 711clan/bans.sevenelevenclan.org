<?php /* Smarty version 2.6.25, created on 2010-08-30 11:22:41
...
" /></td>
				...
				<center><div class="admin_msg">
					<?php if ($this->_tpl_vars['msg']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
<br /><?php endif; ?>
					<?php if ($this->_tpl_vars['statusexport']['exported'] || $this->_tpl_vars['statusexport']['exported'] === 0): ?><?php echo ((is_array($_tmp='_EXPORTED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
: <?php echo $this->_tpl_vars['statusexport']['exported']; ?>
<br /><?php endif; ?>
					<?php if ($this->_tpl_vars['status']): ?><?php echo ((is_array($_tmp='_IMPORTED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
: <?php echo $this->_tpl_vars['status']['imported']; ?>
 / <?php echo ((is_array($_tmp='_FAILED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
: <?php echo $this->_tpl_vars['status']['failed']; ?>
<br /><?php endif; ?>
					<?php if ($this->_tpl_vars['delcount'] || $this->_tpl_vars['delcount'] === 0): ?><?php echo ((is_array($_tmp='_DELETEDBANS')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
: <?php echo $this->_tpl_vars['delcount']; ?>
<br /><?php endif; ?>
					<?php if ($this->_tpl_vars['updatecount'] || $this->_tpl_vars['updatecount'] === 0): ?><?php echo ((is_array($_tmp='_UPDATEDBANSNOTIMPORTED')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
