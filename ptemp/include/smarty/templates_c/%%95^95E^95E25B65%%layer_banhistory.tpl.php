<?php /* Smarty version 2.6.25, created on 2010-09-23 22:32:05
...
<td class="table_list" colspan=10><div style="display: none">
  ...
  (<?php echo $this->_tpl_vars['activ_count']; ?>
					...
					<tr class="htable">
						...
						<td class="fat" width="24%"><?php echo ((is_array($_tmp='_LENGTH')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
						<td>&nbsp;</td>
					</tr>
				</form>
