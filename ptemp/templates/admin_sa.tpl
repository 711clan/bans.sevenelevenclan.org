	...
	<div id="sub-nav">
		...
		{if $smarty.session.amxadmins_view == "yes"}
			...
			<table width="95%" align="center"><tr><td>
				...
				<br />
				{if $msg}<div class="admin_msg" align="center">{$msg|lang}</div>{/if}
						...
						<td align="center">
							<div id="cf{$admins.aid}" {if $admins.aktiv!=1}style="visibility:hidden"{/if} nowrap>
								...
								<img src="images/server_key.png" alt="{"_ACCESSFLAGS"|lang}" style="cursor:pointer;" 
									onClick="window.open('include/amxxhelper.php?id=cftxt'+{$admins.aid},'Link','width=500,height=530,dependent=yes,resizable=yes');return false;" />
							</div>
						</td>
						<td align="center">
