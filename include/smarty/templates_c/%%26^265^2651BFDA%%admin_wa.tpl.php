<?php /* Smarty version 2.6.25, created on 2010-09-06 20:54:32
...
">
			...
			<?php endif; ?>
			<div class="admin_msg"><?php if ($this->_tpl_vars['msg']): ?><?php $_from = $this->_tpl_vars['msg']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['msg']):
?><br /><?php echo ((is_array($_tmp=$this->_tpl_vars['msg'])) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
