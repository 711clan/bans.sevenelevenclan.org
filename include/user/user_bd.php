...
//comment delete
if(isset($_POST["del_comment_x"]) && isset($_POST["cid"])) {
...
//comment edit
if(isset($_POST["edit_comment"]) && isset($_POST["cid"])) {
	if(!$error) {
		//save it to db
...
//file delete
if(isset($_POST["del_demo_x"]) && isset($_POST["did"])) {
...
//file edit
if(isset($_POST["edit_demo"]) && isset($_POST["did"])) {
