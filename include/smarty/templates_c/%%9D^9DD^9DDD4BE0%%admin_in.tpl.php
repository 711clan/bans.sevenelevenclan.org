<?php /* Smarty version 2.6.25, created on 2010-08-30 11:21:53
         compiled from admin_in.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lang', 'admin_in.tpl', 4, false),)), $this); ?>
<div id="navigation">
	<div id="main-nav">
		<ul class="tabbed">
...
" <?php if ($this->_supers['session']['websettings_edit'] != 'yes'): ?>disabled<?php endif; ?>/>
						...
						<?php if ($this->_tpl_vars['msg']): ?><li>
							<div class="admin_msg" style="text-align:center;">
